  ...
  const handleSubmit = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      if (resolveTo === "success" && onSuccess) {
        setTimeout(onSuccess, 300) // delay to show checkmark then scroll
      }
    }, 2000)
  }, [resolveTo, onSuccess])
  ...
  ({ className, onSuccess, ...props }, ref) => {
    ...
    return (
      <motion.div
        ...
        className="shadow-button-inset dark:shadow-button-inset-dark relative flex h-10 items-center justify-center rounded-full bg-white/10 backdrop-blur-md border border-white/5 mx-auto"
      >
        {!completed && (
          <motion.div
            style={{
            ...
            className="absolute inset-y-0 left-0 z-0 rounded-full bg-[#8ae6ff]/20"
          />
        )}
          ...
          {!completed && (
            ...
            >
              <Button
                ...
                size="icon"
                className={cn(
                  "shadow-button rounded-full drop-shadow-xl bg-[#8ae6ff] hover:bg-[#8ae6ff]/90 text-black",
          ...
          {completed && (
            ...
            >
              <Button
                ...
                {...props}
                className={cn(
                  "size-full rounded-full transition-all duration-300 bg-[#8ae6ff] hover:bg-[#8ae6ff]/90 text-black",
                  className
                )}
              >
