...
const CyberneticGridShader = () => {
  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        vec3 gridColor = vec3(0.1, 0.6, 1.0);
        ...
        color += vec3(0.0, 0.8, 1.0) * energy * line * 0.8;
        ...
        // Add depth fade
        float fade = smoothstep(1.5, 0.0, length(uv));
  ...
  return (
    <div
      ref={containerRef}
      className="shader-container absolute inset-0 z-0 pointer-events-none opacity-80 mix-blend-screen"
      style={{
        width: '100%',
        height: '100%',
      }}
